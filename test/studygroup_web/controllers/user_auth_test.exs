defmodule StudygroupWeb.UserAuthTest do
  use StudygroupWeb.ConnCase, async: true

  alias Studygroup.Accounts
  alias StudygroupWeb.UserAuth
  import Studygroup.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, StudygroupWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      StudygroupWeb.Endpoint.subscribe(live_socket_id)
