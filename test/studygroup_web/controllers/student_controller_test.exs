defmodule StudygroupWeb.StudentControllerTest do
  ...
  @create_attrs %{age: 42, description: "some description", email: "some email", name: "some name"}
  @update_attrs %{age: 43, description: "some updated description", email: "some updated email", name: "some updated name"}
